...
class AppTextTheme {
  ...
  static const btext18 = TextStyle(fontSize: 18, color: AppColors.black);
  static const btext18Bold = TextStyle(
      fontSize: 18, fontWeight: FontWeight.bold, color: AppColors.black);
  static const wtext18 = TextStyle(fontSize: 18, color: AppColors.whiteLeve2);
  static const wtext18Bold = TextStyle(
      fontSize: 18, fontWeight: FontWeight.bold, color: AppColors.whiteLeve2);
  ...
  static const wtext16 = TextStyle(fontSize: 16, color: AppColors.whiteLeve2);
  static const wtext16Bold = TextStyle(
      fontSize: 16, fontWeight: FontWeight.bold, color: AppColors.whiteLeve2);
  ...
  static const wtext12 = TextStyle(fontSize: 12, color: AppColors.whiteLeve2);
  static const wtext12Bold = TextStyle(
      fontSize: 12, fontWeight: FontWeight.bold, color: AppColors.whiteLeve2);
}
