    ...
    return Scaffold(
      bottomNavigationBar: Obx(
        () => NavigationBar(
          ...
          onDestinationSelected: (value) => navController.selectedIndex.value = value,
          height: height * .07,
          destinations: [
            NavigationDestination(icon: iconHolder14Black(FontAwesomeIcons.house), label: "Home"),
            NavigationDestination(icon: iconHolder14Black(FontAwesomeIcons.calendar), label: "Bookings"),
            NavigationDestination(icon: iconHolder14Black(Icons.face), label: "Profile"),
          ],
        ),
      ),
...
//               },
//               items: [
//                 BottomNavigationBarItem(icon: iconHolder16Black(FontAwesomeIcons.house), label: 'Home'),
//                 BottomNavigationBarItem(icon: iconHolder16Black(FontAwesomeIcons.calendar), label: 'Bookings'),
//                 BottomNavigationBarItem(icon: iconHolder16Black(FontAwesomeIcons.faceGrimace), label: 'Profile'),
//               ],
//             ),
